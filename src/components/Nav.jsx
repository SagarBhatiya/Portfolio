  ...
  return (
    <>
      <div className="fixed md:w-full bg-[#13131F] md:flex md:gap-6  md: justify-center md:items-center md:bg-[#13131F] ">
        ...
        <div
          className={`w-full  h-[25%] text-white font-bold bg-white/4 flex flex-col gap-4 p-3 ${
            showDetails ? "invisible" : "visible"
          }  md:visible md:flex md:flex-row  md:w-[63%] gap-12  md:mr-30 md:bg-transparent  md:items-center md:justify-around`}
        >
          <a href="#" className="md:hover:text-[#854CE6]">
            Home
          </a>
          <a href="#about" className="md:hover:text-[#854CE6]">
            About
          </a>

          <a href="#skills" className="md:hover:text-[#854CE6]">
            Skills
          </a>
          <a href="#projects"  className="md:pr-10 md:hover:text-[#854CE6]">
            Projects
            </a>
