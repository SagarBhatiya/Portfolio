...
function Nav() {
    ...
    const toggleDetails = ()=>{
       ...
       <>
        ...
        <div className={`w-full  h-[40vh] shadow-lg text-white font-bold bg-white/30 backdrop-blur-md  flex flex-col gap-4 p-3 ${showDetails?'invisible':'visible'} md:shadow-none md:visible md:flex md:flex-row md:h-[10vh] md:bg-[#13131F] md:backdrop-filter-none md:w-[63%] gap-12  md:mr-30 md:bg-transparent  md:items-center md:justify-around`}>
